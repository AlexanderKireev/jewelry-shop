            ...
            <>
              {mode === "signup" && (
                <div>
                  ...
                  <input
                    required
                    className="w-full mt-1 border p-2.5 rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
                    type="text"
              ...
              {mode !== "reset" && (
                <div>
                  ...
                  <div className="relative mt-1">
                    <input
                      required
                      className="w-full border p-2.5 pr-10 rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <button
                disabled={loading}
                type="submit"
                className="w-full bg-blue-600 text-white font-semibold p-3 rounded-xl hover:bg-blue-700 disabled:opacity-50 transition-all shadow-lg shadow-blue-100 mt-2">
                {loading
                  ? "Загрузка..."
                  : mode === "login"
                  ? "Войти"
